...
function numeroMasGrande(numeros) {
  ...
  for (var i = 1; i < numeroMasGrande; i++){
...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  var resultadosDeLaMultimplicacion = 1;
  for (var i = 0; i < arguments.length; i++){
    resultadosDeLaMultimplicacion *= arguments[i];
  }
  return resultadosDeLaMultimplicacion;
}
...
function mayorACien(array) {
  ...
  // Tu código:
  var arrayNumMayoresACien = []
  for(var i = 0; i < array.length; i++){
    if(array[i] > 100){
      arrayNumMayoresACien.push(array[i])
    }
  }
  return arrayNumMayoresACien;
}
